...
import { DealerCenterPage } from "@/components/landing/docs/dealer-center-content";
                ...
                <header className="max-lg:hidden sticky top-0 z-50 ">
                    ...
                    >
                        <Breadcrumbs type="button">
                            ...
                            <Breadcrumbs.Item href="#">DealerCenter</Breadcrumbs.Item>
                        </Breadcrumbs>
