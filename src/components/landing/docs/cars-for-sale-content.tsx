...
export const CarsForSalePage = () => {
  const faqs = [
    {
      q: "How do I connect my CarsforSale feed?",
      a: "Follow the CarsforSale instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does CarsforSale provide?",
      a: "CarsforSale provides comprehensive vehicle data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does CarsforSale sync?",
      a: "CarsforSale feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple CarsforSale accounts?",
      a: "Yes, you can connect multiple CarsforSale accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my CarsforSale connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your CarsforSale feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your CarsforSale inventory feed to sync vehicles automatically.
            </p>
          </div>
          ...
          <Section id="setup-guide" title="Setup guide">
            <p>Follow these steps to connect your CarsforSale inventory feed and start syncing vehicles automatically.</p>
            <StepNavigation />
          </Section>
