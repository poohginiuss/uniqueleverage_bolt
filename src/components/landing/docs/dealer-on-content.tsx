...
export const DealerONPage = () => {
  const faqs = [
    {
      q: "How do I connect my DealerON feed?",
      a: "Follow the DealerON instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does DealerON provide?",
      a: "DealerON provides comprehensive vehicle data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does DealerON sync?",
      a: "DealerON feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple DealerON accounts?",
      a: "Yes, you can connect multiple DealerON accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my DealerON connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your DealerON feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your DealerON inventory feed to sync vehicles automatically.
            </p>
          </div>
          ...
          <Section id="setup-guide" title="Setup guide">
            <p>Follow these steps to connect your DealerON inventory feed and start syncing vehicles automatically.</p>
            <StepNavigation />
          </Section>
