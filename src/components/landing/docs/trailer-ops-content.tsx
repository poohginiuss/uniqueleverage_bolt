...
export const TrailerOpsPage = () => {
  const faqs = [
    {
      q: "How do I connect my Trailer Ops feed?",
      a: "Follow the Trailer Ops instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does Trailer Ops provide?",
      a: "Trailer Ops provides comprehensive trailer and equipment data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does Trailer Ops sync?",
      a: "Trailer Ops feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple Trailer Ops accounts?",
      a: "Yes, you can connect multiple Trailer Ops accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my Trailer Ops connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your Trailer Ops feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your Trailer Ops inventory feed to sync trailers and equipment automatically.
            </p>
          </div>
          ...
          <Section id="setup-guide" title="Setup guide">
            <p>Follow these steps to connect your Trailer Ops inventory feed and start syncing trailers and equipment automatically.</p>
            <StepNavigation />
          </Section>
