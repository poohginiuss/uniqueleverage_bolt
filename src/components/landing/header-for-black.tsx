...
const headerNavItems: HeaderNavItem[] = [
    { label: "What’s included?", href: "/products", menu: <DropdownMenuSimpleTwoColumnsWithFooter  /> },
            ...
            <div className="flex size-full max-w-container flex-1 items-center pr-3 pl-4 md:px-8">
                ...
                >
                    <div className="flex flex-1 items-center gap-5">
                        ...
                        <UntitledLogo className="h-9 md:max-lg:hidden" />
                        <UntitledLogoMinimal className="hidden h-9 md:inline-block lg:hidden" />
                        </a>
                        {/* Desktop navigation */}
