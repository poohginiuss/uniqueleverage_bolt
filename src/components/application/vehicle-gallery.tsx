    ...
    <div>
      ...
      <div className="hidden md:block relative">
        ...
        <div className="absolute bottom-2 right-2 z-10 hidden md:block">
          <button
            onClick={navigateToPhotoGallery}
            className="inline-flex items-center px-2 py-1 bg-white backdrop-blur-sm text-black text-sm font-medium rounded-lg border border-gray-900 shadow-sm hover:bg-white hover:shadow-md transition-all"
          >
